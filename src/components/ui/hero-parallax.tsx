...
export const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 h-full w-full opacity-0 group-hover/product:opacity-80 bg-black rounded-lg pointer-events-none transition-opacity duration-300"></div>

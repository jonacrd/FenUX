...
const HeroLandingV2: React.FC<HeroLandingV2Props> = ({
  title,
  subtitle,
  badges,
  image,
  ...
  useEffect(() => {
    // Preload images
    const preloadImages = [image, '/images/landing-shot-1.webp', '/images/landing-shot-2.webp'];
